...
import com.maggiver.wigilabspruebamaggiver.data.repository.RepositoryImpl
import com.maggiver.wigilabspruebamaggiver.domain.PopularMovieUserCase
...
abstract class BindContractsModule {
    ...
    @Binds
    abstract fun popularMovieUserCase(userCasePopularMovie: PopularMovieUserCase): PopularMovieUserCaseContract
